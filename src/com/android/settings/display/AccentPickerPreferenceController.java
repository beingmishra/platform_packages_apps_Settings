...
import com.android.settings.fred.themes.AccentPicker;

import com.android.internal.util.fred.FredUtils;
...
public class AccentPickerPreferenceController extends AbstractPreferenceController
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (!FredUtils.isPackageInstalled(mContext, SUBS_PACKAGE)) {
